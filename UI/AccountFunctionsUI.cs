...
namespace ManageAccountApp.UI
{
    public class AccountFunctionsUI
    {
        ...
        public void AddAccount()
        {
            ...
            Console.WriteLine($"  - Tài khoản tiết kiệm (4.7%): {balance / 2:N0} VND");
            Console.WriteLine($"  - Tài khoản thanh toán (5.1%): {balance / 2:N0} VND");
        }
        ...
        public void Deposit()
        {
            ...
            var updatedAccount = _accountService.GetAccountInfoById(id);
            ...
            switch (choice)
            {
                case "1":
                    ...
                    if (result)
                        ...
                        Console.WriteLine("✗ Rút tiền thất bại (ID sai hoặc số dư không đủ).");
                    break;
